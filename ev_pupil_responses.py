...
for subname in sublist:
	...
	# # Get pupil data (ev)
	pa.signal_per_trial(only_correct = True, only_incorrect = False, reference_phase = 7, with_rt = True, baseline_type = 'absolute', baseline_period = [-0.5, 0.0], force_rebuild=False, down_sample = True)
	...
	pa.signal_per_trial(only_correct = True, only_incorrect = False, reference_phase = 4, with_rt = False, baseline_type = 'absolute', baseline_period = [-.5, 0.0], force_rebuild=False, down_sample = True)
